...
# Hypercolumn based method for Pascal datasets.
...
if __name__ == "__main__":
    ...
    file_folder = '/Users/nanliu/hypercolumns/pascal/bicycle/'
    ...
    for cc in range(len(cluster_num)):
        ...
        fig.savefig(file_folder + 'bicycle_conv13_' + str(cluster_num[cc]), bbox_inches='tight')
