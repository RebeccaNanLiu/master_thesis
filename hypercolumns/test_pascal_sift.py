...
# SIFT based method for Pascal datasets.
...
if __name__ == "__main__":
    ...
    save_folder = '/Users/nanliu/Desktop/'
    images = read_and_preprocess_txt(os.path.join(file_folder, 'test_5.txt'))
    IMG_NUM = len(images)
    positives_num = 325
    negatives_num = 16
    ...
    for cc in range(len(cluster_num)):
        ...
        file = open('/Users/nanliu/Desktop/sheep_5_percent.txt', 'w')
        for j in range(8):
        ...
        fig.savefig(save_folder+'sheep_5p_sift', bbox_inches='tight')
