...
# test for performance of Hypercolumn based method towards noise ratio.
...
if __name__ == "__main__":
    ...
    file_folder = '/Users/nanliu/hypercolumns/pascal/sheep/'
    input_images = read_and_preprocess_txt(os.path.join(file_folder, 'test_1.txt'))
    ...
    for cc in range(len(cluster_num)):
        ...
        file = open('/Users/nanliu/Desktop/sheep_1_percent.txt', 'w')
        for j in range(8):
        ...
        fig.savefig(file_folder + 'sheep_1_percent.jpg', bbox_inches='tight')
