...
# Hypercolumn based method for Synthetic datasets.
...
if __name__ == "__main__":
    ...
    images_dir = 'generated/generated_5/'
    ...
    # SIFT as detector, Hypercolumns as descriptor
    Kpts_per_img = []
    desc_list = []
    ...
    for cc in range(len(cluster_num)):
        ...
        file = open('/Users/nanliu/hypercolumns/v5_conv10_2048.txt', 'w')
        for j in range(8):
