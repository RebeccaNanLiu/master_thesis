%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% manually generate images and extract color histogram features
%% by Nan Liu
%% Apr. 26, 2017
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if 0
%% generate 90 pos, 10 neg images for v5
folder_name = '/Users/nanliu/Documents/MATLAB/codeBooks/generated_v1';
[X, Y] = generate_images_v1( 90, 10, folder_name);
save X; 
save Y;
end 
...
for i = 1 : N
    ...
    I_padded = padarray(I,[24,24]);
    desc= [];
    for j = 1:20
        xmin = X(i, j);
        ymin = Y(i, j);
        I2 = imcrop(I_padded,[xmin ymin 48 48]);
       
        hsvColorHistogram = hsvHistogram(I2);
        desc = [desc transpose(hsvColorHistogram)];
    end
...
for i = 1:100
    assignments_bro(1, 20*(i-1)+1:20*i) = i;
end 
